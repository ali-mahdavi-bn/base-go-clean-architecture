...
func (a *Role) Query(ctx context.Context, params entities.RoleQueryParam) (*entities.RoleQueryResult, error) {
	params.Pagination = true

	var selectFields []string
	if params.ResultType == entities.RoleResultTypeSelect {
		params.Pagination = false
		selectFields = []string{"id", "name"}
	}

	result, err := a.RoleDAL.Query(ctx, params, entities.RoleQueryOptions{
...
func (a *Role) Get(ctx context.Context, id string) (*entities.Role, error) {
	...
	roleMenuResult, err := a.RoleMenuDAL.Query(ctx, entities.RoleMenuQueryParam{
		RoleID: id,
	})
	if err != nil {
		return nil, err
...
func (a *Role) Create(ctx context.Context, formItem *entities.RoleForm) (*entities.Role, error) {
...
func (a *Role) Update(ctx context.Context, id string, formItem *entities.RoleForm) error {
	role, err := a.RoleDAL.Get(ctx, id)
	if err != nil {
		return err
	} else if role == nil {
