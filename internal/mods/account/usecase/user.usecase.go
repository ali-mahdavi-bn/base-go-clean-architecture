...
func (a *User) Query(ctx context.Context, params entities.UserQueryParam) (*entities.UserQueryResult, error) {
	params.Pagination = true

	result, err := a.UserDAL.Query(ctx, params, entities.UserQueryOptions{
...
func (a *User) Get(ctx context.Context, id string) (*entities.User, error) {
	user, err := a.UserDAL.Get(ctx, id, entities.UserQueryOptions{
		QueryOptions: util.QueryOptions{
			OmitFields: []string{"password"},
		},
	})
...
func (a *User) Create(ctx context.Context, formItem *entities.UserForm) (*entities.User, error) {
...
func (a *User) Update(ctx context.Context, id string, formItem *entities.UserForm) error {
