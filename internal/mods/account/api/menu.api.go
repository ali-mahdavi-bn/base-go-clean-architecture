...
// @Router /api/v1/account/menus [get]
func (a *Menu) Query(c *gin.Context) {
	ctx := c.Request.Context()
	var params entities.MenuQueryParam
	if err := util.ParseQuery(c, &params); err != nil {
		util.ResError(c, err)
		return
	}

	result, err := a.MenuUC.Query(ctx, params)
	if err != nil {
		util.ResError(c, err)
		return
	}
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/p/menus [get]
func (a *Menu) PQuery(c *gin.Context) {
	ctx := c.Request.Context()
	var params entities.MenuQueryParam
	if err := util.ParseQuery(c, &params); err != nil {
		util.ResError(c, err)
	...
	params.Public = entities.MenuStatusPublic
	result, err := a.MenuUC.PQuery(ctx, params)
	if err != nil {
		util.ResError(c, err)
		return
	}
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/account/menus/{id} [get]
func (a *Menu) Get(c *gin.Context) {
	ctx := c.Request.Context()
	item, err := a.MenuUC.Get(ctx, c.Param("id"))
	if err != nil {
		util.ResError(c, err)
		return
	}
...
// @Param body body entities.MenuForm true "Request body"
// @Success 200 {object} util.ResponseResult{data=entities.Menu}
// @Failure 400 {object} util.ResponseResult
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/account/menus [post]
func (a *Menu) Create(c *gin.Context) {
	ctx := c.Request.Context()
	item := new(entities.MenuForm)
	...
	result, err := a.MenuUC.Create(ctx, item)
	if err != nil {
		util.ResError(c, err)
		return
	}
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/account/menus/{id} [put]
func (a *Menu) Update(c *gin.Context) {
	...
	err := a.MenuUC.Update(ctx, c.Param("id"), item)
	if err != nil {
		util.ResError(c, err)
		return
	}
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/account/menus/{id} [delete]
func (a *Menu) Delete(c *gin.Context) {
	ctx := c.Request.Context()
	err := a.MenuUC.Delete(ctx, c.Param("id"))
	if err != nil {
		util.ResError(c, err)
		return
	}
